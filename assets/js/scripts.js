$(document).ready(function () {
  ...
  var $menuLinks = $('.intake_menu a[href^="#"], .mobile-product-menu .menu-item[href^="#"]');
  ...
  $menuLinks.on("click", function (e) {
    ...
    if (targetId && targetId !== "#") {
      ...
      if ($target.length) {
        ...
        var targetOffset = $target.offset().top - $scrollContainer.offset().top + containerScrollTop - 80;

        $scrollContainer.animate({scrollTop: targetOffset}, 600);

        // Sync active state for desktop + mobile
        $menuLinks.removeClass("active");
        $menuLinks.filter('[href="' + targetId + '"]').addClass("active");
      }
    }
  });
  ...
  $scrollContainer.on("scroll", function () {
    ...
    $menuLinks.each(function () {
      ...
      if (targetId && targetId !== "#") {
        ...
        if ($target.length) {
          var sectionTop = $target.offset().top - $scrollContainer.offset().top + scrollPos - 120;
